...
class MigrationHelper {
  ...
  static Future<void> migrateUserData(String newUserId) async {
    try {
      ...
      final bool migrationCompleted = prefs.getBool(_migrationCompletedKey) ?? false;
      ...
      debugPrint('Migrating data from old ID: $oldUserId to new ID: $newUserId');
  ...
  static Future<void> _migrateNotifications(String oldUserId, String newUserId) async {
    try {
  ...
  static Future<void> _migrateSubscriptions(String oldUserId, String newUserId) async {
    try {
